...
year = int(
    input(
        "Type year you want to show(2000, 2005, \
2010 or 2015) ---> "
    )
)

# Read dataset from local csv file
file_path = f"/app/{year}_DID_TFP.csv"
...
# Store plot to the file
plt.savefig(f"/app/{year}_scatter_plot.png")

# Output file path instead of displaying plot
print(f"Plot saved as /app/{year}_scatter_plot.png")
